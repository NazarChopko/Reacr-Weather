...
export const GlobalSvgSelector = ({ id, isTab }: Props) => {
  switch (id) {
    case "header-logo":
      return (
        <svg
    ...
    case "error":
      return (
        ...
        >
          <path
            fill="#feca18"
            d="M 79.83 71.24 L 57 75.21 s -7.6 19.36 -8.07 20.67 c -0.47 1.31 -0.45 3.38 1.62 3.38 c 2.63 0 15.98 -0.07 15.98 -0.07 s -3.24 15.63 -3.43 17.03 s 1.31 2.63 2.63 1.22 c 1.31 -1.41 19.51 -24.79 20.3 -25.93 c 1.41 -2.04 0.05 -3.92 -1.55 -4.01 c -1.6 -0.09 -12.32 0.14 -12.32 0.14 l 7.67 -16.4 Z"
          />
          <path
            fill="#fdb900"
            d="M 73.71 75.04 s -5.09 11.26 -5.28 11.9 c -0.56 1.9 1.9 2.67 2.6 1.13 c 0.7 -1.55 6.76 -14.08 6.76 -14.08 l -4.08 1.05 Z"
          />
          <path
            fill="#fdb900"
            d="M 50.83 96.3 c 1.34 -0.04 13.1 -0.07 14.08 -0.14 c 1.83 -0.14 2.11 2.39 0 2.39 c -2.19 0 -13.73 0.04 -14.43 0.07 c -1.62 0.08 -1.83 -2.25 0.35 -2.32 Z"
          />
          <path
            fill="#ffe36a"
            d="M 59.98 75.96 s -6 15.06 -6.34 16.19 c -1.41 4.72 3.66 4.58 5 1.9 c 0.66 -1.33 7.11 -14.99 7.39 -17.46 c 0.29 -2.46 -6.05 -0.63 -6.05 -0.63 Z"
          />
          <path
            fill="#ffe36a"
            d="M 62.52 91.16 c -0.86 -0.59 -1.9 -0.07 -2.53 0.92 c -0.63 0.99 -1.55 2.6 -0.14 3.45 c 1.27 0.76 2.39 -0.77 2.89 -1.48 c 0.48 -0.7 1.11 -1.97 -0.22 -2.89 Z"
          />
          <path
            fill="#ffe36a"
            d="M 72.09 94.4 c -2.29 -0.49 -3.03 1.41 -3.52 3.66 c -0.49 2.25 -2.33 9.53 -2.67 11.33 c -0.49 2.53 1.83 2.89 2.82 0.56 c 0.74 -1.74 3.95 -9.59 4.36 -10.84 c 0.63 -1.89 1.33 -4.22 -0.99 -4.71 Z"
          />
          <path
            fill="#e4eaee"
            d="M 107.35 50.2 s 1.29 -34.78 -27.45 -39 C 53.01 7.26 48.23 32.6 48.23 32.6 s -11.68 -2.67 -18.02 4.79 s -6.48 13.23 -6.48 13.23 s -17.6 -1.69 -19.15 12.67 s 11.54 8.45 11.54 8.45 l 107.13 -4.72 s 2.95 -8.03 -4.65 -13.73 c -4.49 -3.37 -11.25 -3.09 -11.25 -3.09 Z"
          />
          <radialGradient
            id="IconifyId17ecdb2904d178eab6089"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(0.0288 -0.9996 1.4975 0.0432 -54.843 141.038)"
            cx="65.427"
            cy="79.054"
            r="29.294"
            fx="52.312"
            fy="79.18"
          >
            <stop stop-color="#ffe366" offset="0.193" />
            <stop stop-color="#eddd82" offset="0.331" />
            <stop stop-color="#d0d4ad" offset="0.571" />
            <stop stop-color="#bfcfc7" offset="0.759" />
            <stop stop-color="#b8cdd1" offset="0.87" />
          </radialGradient>
          <path
            fill="url(#IconifyId17ecdb2904d178eab6089)"
            d="M 58.78 55.69 c 0.84 -0.28 6.05 4.22 19.85 3.8 s 26.61 -7.32 26.61 -7.32 s -0.7 4.93 -2.25 7.32 s -4.22 5.21 -4.22 5.21 s 7.18 1.69 13.66 0.84 c 6.48 -0.84 11.26 -3.94 11.26 -3.94 s 0.84 3.24 0.28 6.34 c -0.72 3.97 -4.22 6.9 -7.18 7.32 s -29.56 1.76 -39.98 2.11 c -8.45 0.29 -56.63 0.68 -61.52 0.14 c -5.07 -0.56 -8.87 -2.82 -10.28 -7.18 c -1.07 -3.31 -0.56 -5.35 -0.56 -5.35 s 6.36 2.73 11.54 1.83 c 6.48 -1.13 10 -6.19 10 -6.19 s 6.34 3.24 15.49 2.11 c 9.14 -1.13 17.3 -7.04 17.3 -7.04 Z"
          />
        </svg>
      );
